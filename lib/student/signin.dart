...
import 'package:eureka/utils/painter.dart';
import 'package:eureka/utils/theme.dart' as Theme;
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        decoration: new BoxDecoration(
                          ...
                          gradient: new LinearGradient(
                              colors: [Color(0xFFFFFFFF), Color(0xFF1e88e5)],
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (val) => val.length < 4
                                        ? 'Username should be of 4 characters at lease'
                                        : null,
                                  ),
                                ),
                                Container(
                      ...
                      child: MaterialButton(
                          ...
                          onPressed: () async {
                            DatabaseMethods databaseMethods =
                                new DatabaseMethods();
                            final valid =
                                await databaseMethods.usernameCheck(username);
                            if (!valid) {
                              ...
                              dynamic result =
                                  await _auth.studentSignUpEmailPassword(
                                      username, email, password, userLocation);
                              if (result == null) {
                                setState(() {
                                  loading = false;
