...
class Auth
{
  ...
  Future tutorSignUpEmailPassword(String username, String email, String password, UserLocation userLocation) async
  {
    try
    {
  ...
  //merchant sign up
  Future studentSignUpEmailPassword(String username, String email, String password, UserLocation userLocation) async
  {
    try
    {
      AuthResult result = await _auth.createUserWithEmailAndPassword(email: email, password: password);
